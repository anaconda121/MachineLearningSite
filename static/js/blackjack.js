...
const hit_sound = new Audio("../../static/assets/sounds/blackjack/swish.m4a");
const win_sound = new Audio("../../static/assets/sounds/blackjack/cash.mp3");
const loss_sound = new Audio("../../static/assets/sounds/blackjack/loss.mp3");
...
function show_card(card, active_player) {
    if (active_player['score'] <= 21){
        ...
        card_image.src = `../../assets/images/blackjack/${card_image}.png`;
